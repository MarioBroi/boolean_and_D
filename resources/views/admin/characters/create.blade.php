            ...
            <form action="{{ route('admin.characters.store') }}" method="post" class="card-create">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control character-text" name="full_name" id="full_name"
                        @error('full_name') is-invalid @enderror aria-describedby="fullNameHelper" placeholder="Full Name"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control character-text" name="alignment" id="alignment"
                        @error('alignment') is-invalid @enderror aria-describedby="alignmentHelper" placeholder="Alignment"
                        value="{{ old('alignment') }}" />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control character-text" name="health_points" id="health_points"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control character-text" name="sub_class" id="sub_class"
                        @error('sub_class') is-invalid @enderror aria-describedby="subClassHelper" placeholder="Sub-Class"
                        value="{{ old('sub_class') }}" />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control character-text" name="armour_class" id="armour_class"
