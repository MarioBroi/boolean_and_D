                    ...
                    <div class="card w-75 p-5 better-view border-0">
                        <form action="{{ route('admin.characters.update', $character) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <small id="healthPointsHelper" class="form-text text-muted">Type the health points</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small id="armourClassHelper" class="form-text text-muted">Type the armour class</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small id="backstoryHelper" class="form-text text-muted"> Type the backstory</small>
                            </div>
