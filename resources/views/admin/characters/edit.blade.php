                    ...
                    <form action="{{ route('admin.characters.update', $character) }}" method="post" class="better-view">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="full_name" id="full_name"
                                ...
                                value="{{ old('full_name', $character->full_name) }}"
                                @error('full_name') is-invalid @enderror " required />
    ...
    @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="sex" id="sex"
                                                        aria-describedby="sexHelper" placeholder="Sex" value="{{ old('sex', $character->sex) }}" />
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="age" id="age"
                                                        aria-describedby="ageHelper" placeholder="Age" value="{{ old('age', $character->age) }}" />
                                            ...
                                            <form action="{{ route('admin.characters.update', $character) }}" method="post" class="better-view">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="alignment" id="alignment"
                                                        ...
                                                        value="{{ old('alignment', $character->alignment) }}" />
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="health_points" id="health_points"
                                                        ...
                                                        value="{{ old('text', $character->health_points) }}"  />
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="sub_class" id="sub_class"
                                                        ...
                                                        value="{{ old('sub_class', $character->sub_class) }}" />
                                            ...
                                            <form action="{{ route('admin.characters.update', $character) }}" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="cd" id="cd"
                                                        aria-describedby="cdHelper" placeholder="CD" value="{{ old('cd', $character->cd) }}" />
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="backstory" id="backstory" aria-describedby="backstoryHelper"
                                                        placeholder="Backstory">{{ old('backstory', $character->backstory) }}</textarea>
